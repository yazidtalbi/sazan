          ...
          >
            ...
            >
              <div className="masterplan-map-breath">
                ...
                <MasterplanLocations visible={markersVisible} onSelectionChange={handleLocationSelection} />
              </div>
            </div>
            ...
            <div className="masterplan-two-cols">
              ...
              <div className="masterplan-col-card">
                <div className="masterplan-col-img">
                  <img
                    src="https://images.unsplash.com/photo-1483728642387-6c3bdd6c93e5?auto=format&fit=crop&w=1000&q=85"
                    alt="Green Infrastructure Biking"
                  />
                </div>
              ...
              <div className="masterplan-col-card">
                <div className="masterplan-col-img">
                  <img
                    ...
                    alt="Resort Architecture Vision"
                  />
                </div>
                <div className="masterplan-col-content">
